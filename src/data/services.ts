...
export const services: Service[] = [
  ...
  },
  {
    ...
    shortDescription: "Technology-focused audit services covering controls, security and compliance posture.",
    description:
      "Our Information Systems Audit services evaluate IT control environments, system reliability and compliance readiness. We help organizations improve technology governance and reduce digital risk.",
    offerings: [
      { title: "IT Controls Review", description: "Assessment of general and application controls across IT environments." },
      { title: "Security Assessment", description: "Control testing and vulnerability-focused review for critical systems." },
      { title: "Compliance Audits", description: "Technology compliance audits aligned to regulatory and policy expectations." },
      { title: "System Evaluation", description: "Performance and control review of core business applications." }
    ],
    benefits: [
      "Stronger IT governance and oversight",
      "Improved control effectiveness across systems",
      "Greater security and compliance confidence",
    ...
    faqs: [
      {
        question: "Is IS audit relevant for mid-sized organizations?",
        answer: "Yes. As digital dependency grows, IT control assurance becomes essential for organizations of all sizes."
      },
      {
        question: "Do you provide actionable remediation guidance?",
        answer: "Yes. Engagement outputs include prioritized recommendations and control-improvement pathways."
      }
    ],
    seo: {
      title: "Information Systems Audit Services | AGV Reddy & Co.",
      description: "IT controls review, security assessment, compliance audits and system evaluation services.",
      keywords: ["is audit", "information systems audit", "it controls", "security assessment", "compliance audit"],
      openGraphTitle: "Information Systems Audit Services",
      openGraphDescription: "Technology assurance services to strengthen digital controls and risk resilience."
    }
  },
  {
    id: 8,
    ...
    shortDescription: "Independent transaction diligence to support informed investment and acquisition decisions.",
    description:
      "Our Financial Due Diligence team evaluates financial quality, risk and transaction considerations for investors, acquirers and promoters. We help clients move forward with clarity and confidence.",
    offerings: [
      { title: "Financial Review", description: "Deep review of financial statements, trends and quality of earnings." },
      { title: "Risk Assessment", description: "Identification of financial, operational and compliance-related risks." },
      { title: "Acquisition Support", description: "Diligence assistance across pre-deal evaluation and negotiation stages." },
      { title: "Transaction Advisory", description: "Decision support with focused insights on deal structure implications." }
    ],
    benefits: [
      "Reduced deal uncertainty",
      "Visibility into financial quality and risk",
      "Better negotiation support with evidence",
      "Structured insights for post-deal planning"
    ],
    industries: industryCatalog,
    process: defaultProcess,
    faqs: [
      {
        question: "When should due diligence begin in a transaction cycle?",
        answer: "Early diligence is recommended to identify red flags and shape valuation and negotiation strategy."
      },
      {
        question: "Do you coordinate with legal and commercial advisors?",
        answer: "Yes. We collaborate with transaction teams to provide integrated decision support."
      }
    ],
    seo: {
      title: "Financial Due Diligence Services | AGV Reddy & Co.",
      description: "Financial review, risk assessment and transaction advisory support for acquisitions and investments.",
      keywords: ["financial due diligence", "transaction advisory", "acquisition support", "risk assessment"],
      openGraphTitle: "Financial Due Diligence Services",
      openGraphDescription: "Evidence-based diligence insights for confident transaction decisions."
    }
  }
];
